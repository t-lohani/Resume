...
\address{
631-652-5063 $\bullet$ \href{mailto:tlohani@cs.stonybrook.edu}{tlohani@cs.stonybrook.edu} $\bullet$      
...
Languages & Java, C, JavaScript, Python, Prolog, SML.
\\
Web Technologies & NodeJS, HTML5, CSS, Pyhton Flask, RESTful API, SOAP, AWS, D3.
\\
...
\item OTIS Field Application -- As owner of Job management module of tablet application, implemented job status change, display jobs on map, search/sort/forward a job, order parts consuming SOAP services provided by the client. Implemented changes sync to enterprise database using Kony Sync Framework.

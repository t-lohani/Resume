...
{CGPA - 3.58/4.0} 
Courses: Analysis of Algorithms, Operating Systems, Artificial Intelligence, Data Science Fundamentals, Probability and Statistics for Data Scientists, Visualization, Principles of Database Systems, Computational Biology, Wireless and Mobile Networks, Theory of Computation, Principles of Programming Languages.
\end{rSubsection}
...
\begin{rSubsection}{Conference Management and Ticketing System} {\emph {Feb 2017 -- Present}}{}{}
	\item Developed and documented APIs for scheduling meeting and sending notifications to the invitees using NodeJS, Java and Swagger. This web based application will be used in the upcoming conferenes at CEWIT, Stony Brook.
\end{rSubsection}
